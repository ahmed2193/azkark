...
import 'package:azkark/services/data.dart';
import 'package:azkark/services/models.dart';
import 'package:azkark/services/pref.dart';
...
ForeGroundWidget(this.nextPrayer, this.reminderTime, this.currentPrayer, {Key key}) : super(key: key);
  ...
  final Prayerr nextPrayer;
  final Prayerr currentPrayer;
  ...
  Widget cardWidget(BuildContext context) => Card(
        ...
        child: Container(
          decoration: const BoxDecoration(
              ...
              image: DecorationImage(image: AssetImage("assets/images/azan/card_background.png"), fit: BoxFit.cover)),
          alignment: Alignment.center,
          padding: const EdgeInsets.only(top: 20, bottom: 20),
          child: Column(
            children: [
              FittedBox(child: listOfTimes(prayerrs)),
  ...
  Widget listOfTimes(List<Prayerr> prayers) {
    return Row(
      children: [
  ...
  Widget timeWithTitle(Prayerr prayer) {
    return Container(
